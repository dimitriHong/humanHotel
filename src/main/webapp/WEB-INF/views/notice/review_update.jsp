		...
		<section>
			...
			<article id="mainarticle">
				<div class="mainarticle_wrap">
					<form action="review_update_action" method="post" id="form">
						<div id="client_question">
							<div class="main_title">
								<h1>후기 게시판</h1>
							</div>

							<input type="text" size="50px" name="review_id" id="review_id"
							...
							<table id="que_info">
								...
								<tr class="que_tr">
									...
									<td><input type="text" size="50px" name="review_title"
										id="que_title" value="${detail.review_title}"></td>
								</tr>
								<tr class="que_tr">
									<td class="que_left">&nbsp;내용 :</td>
									<td><textarea name="review_content" id="que_ct">${detail.review_content}</textarea></td>
								</tr>
								<tr class="que_tr">
							...
							<input type="submit" value="저장" id="btn_submit">
						</div>
					</form>
				</div>
			</article>
