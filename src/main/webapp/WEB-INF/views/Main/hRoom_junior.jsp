...
<head>
	<meta charset="UTF-8">
	<title>휴먼호텔소개 - Junior Suite Room</title>
	                    ...
	                    <div class="mainarticle_wrap">
	                        <div class="main_head">
	                       	...
	                       	<div class="section">
	                       		<ul class="bxslider"> 
						    		<li>
						    			<img src="${pageContext.request.contextPath}/resources/room_img/junior01.jpg" height=300px width=740px; alt="">
						    		</li> 
						    		<li>
						    			<img src="${pageContext.request.contextPath}/resources/room_img/junior02.jpg" height=300px width=740px; alt="">
						    		</li> 
						    		<li>
						    			<img src="${pageContext.request.contextPath}/resources/room_img/junior03.jpg" height=300px width=740px; alt="">
						    		</li> 
						    		<li>
						    			<img src="${pageContext.request.contextPath}/resources/room_img/junior04.jpg" height=300px width=740px; alt="">
						    		</li> 
						    	</ul>
						  		<div class="room_info_up">
                            		<p><b id="up_title">객실 상세 정보</b><br>
                                	 휴먼의 주니어 스위트룸은 우아한 인테리어와 은은한 원목가구풍의 색으로 일관성있고 고급스러운 실내분위기를 자랑하는 객실입니다.<br />
                                		철저한 보안시스템 및 개별 냉난방 시설을 완비하고 있어 사시사철 불편함이 없이 이용하실수 있습니다.
                            		</p>                            
                        		</div>
