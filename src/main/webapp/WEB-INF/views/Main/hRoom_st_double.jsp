...
<head>
	<meta charset="UTF-8">
	<title>휴먼호텔소개 - Standard Double Room</title>
		...
		<div id="sectionlist">
			<article id="sidemenu">
				<div id="sidemenu1">
					...
					<ul>
						...
						<li><a href="${pageContext.request.contextPath}/roomlist">객실
								소개</a></li>
						<li><a href="#">주변 관광지</a></li>
						<li><a href="${pageContext.request.contextPath}/waytocome">찾아오시는
								길</a></li>
					</ul>
				</div>
			</article>
			<article id="mainarticle">
				<div class="mainarticle_wrap">
					<div class="main_head">
						<p id="b_title">
							스탠다드 더블 룸 <b id="s_title">(STANDARD DOUBLE ROOM)</b>
						</p>
					</div>
					<div class="section">
						<ul class="bxslider">
							<li><img
								src="${pageContext.request.contextPath}/resources/room_img/standard_doble01.jpg"
								height=300px width=740px; alt=""></li>
						</ul>
						<div class="room_info_up">
							<p>
								<b id="up_title">객실 상세 정보</b><br> 휴먼의 스탠다드 더블룸은 편안하고 아늑한
								분위기의 실내 인테리어와 쾌적한 공간, 가족같은 서비스등 내집처럼 부담없이 이용하실 수 있게 마련되어 있습니다.
							</p>
						</div>
						<div class="room_info_down">
							<div class="info_box">
								<p>
									<b>객실 서비스</b><br /> &#8211; 전객실 무료 Wi-Fi 지원<br /> &#8211;
									24시간 메세지 전달 서비스<br /> &#8211; 개별 욕실과 샤워시설, 개별 냉난방 시설<br />
									&#8211; 국제 직통 전화<br /> &#8211; Cable TV 설치, 해외 방송<br />
									&#8211; 냉장고와 미니바, 식수
								</p>
							</div>
							<div class="info_box">
								<p>
									<b>정상가</b><br /> 180,000 (봉사료, 세금포함)
								</p>
								<p>객실 예약전화 : 032-556-0880</p>
							</div>
							<div class="info_box">
								<p>
									<b>체크인/체크아웃</b><br /> Check In 오후 2시<br /> Check Out 오후
									12시(정오)
								</p>
							</div>
						</div>
