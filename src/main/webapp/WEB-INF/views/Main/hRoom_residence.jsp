...
<head>
	<meta charset="UTF-8">
	<title>휴먼호텔소개 - Residence Room</title>
            ...
            <div id="sectionlist">
                ...
                <article id="mainarticle">
	                    <div class="mainarticle_wrap">
	                        <div class="main_head">
	                            <p id="b_title">레지던스 룸
	                                <b id="s_title">(RESIDENCE ROOM)</b>
	                            </p>
	                        </div>
	                       	<div class="section">
	                       		<ul class="bxslider"> 
						    		<li>
						    			<img src="${pageContext.request.contextPath}/resources/room_img/residence01.jpg" height=300px width=740px; alt="">
						    		</li> 
						    		<li>
						    			<img src="${pageContext.request.contextPath}/resources/room_img/residence02.jpg" height=300px width=740px; alt="">
						    		</li> 
						    		<li>
						    			<img src="${pageContext.request.contextPath}/resources/room_img/residence03.jpg" height=300px width=740px; alt="">
						    		</li> 
						    	</ul>
						  		<div class="room_info_up">
                            		<p><b id="up_title">객실 상세 정보</b><br>
                                	휴먼의 레지던스룸은 자신의 집에 있는 듯한 안락한 공간과 시설을 갖추고 있으며, 취사가 가능한 완벽한 주방 시설은 물론 최저한 보안시스템 및 개별 냉난방 시설을 완비하고 있어 사시사철 전혀 불편함이 없이 가족단위 또는 장기 비즈니스 고객에게 적합하도록 꾸며져 있습니다.
                            		</p>                            
                        		</div>
