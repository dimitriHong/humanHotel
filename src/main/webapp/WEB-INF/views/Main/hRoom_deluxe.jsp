...
<head>
	<meta charset="UTF-8">
	<title>휴먼호텔소개 - Deluxe Double Room</title>
            ...
            <div id="sectionlist">
                ...
                <article id="mainarticle">
	                    <div class="mainarticle_wrap">
	                        <div class="main_head">
	                            <p id="b_title">디럭스 더블 룸
	                                <b id="s_title">(Deluxe Double Room)</b>
	                            </p>
	                        </div>
	                       	<div class="section">
	                       		<ul class="bxslider"> 
						    		<li>
						    			<img src="${pageContext.request.contextPath}/resources/room_img/deluxe_double02.jpg" height=300px width=740px; alt="">
						    		</li> 
						    		<li>
						    			<img src="${pageContext.request.contextPath}/resources/room_img/deluxe_double03.jpg" height=300px width=740px; alt="">
						    		</li> 
						    		<li>
						    			<img src="${pageContext.request.contextPath}/resources/room_img/deluxe_double05.jpg" height=300px width=740px; alt="">
						    		</li> 
						    	</ul>
						  		<div class="room_info_up">
                            		<p><b id="up_title">객실 상세 정보</b><br>
                                	휴먼의 디럭스 더블룸은 보다 차별화된 서비스를 원하시는 비즈니스맨 및 관광객을 위해 디자인된 객실입니다.
									최고 수준의 편리함과 품격, 세련미를 느낄 수 있게 마련되어 있습니다.
                            		</p>                            
                        		</div>
